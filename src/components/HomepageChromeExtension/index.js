                  ...
                  <div className="flex flex-wrap -m-8">
                      ...
                      <div className="w-full md:w-1/2 p-8">
                          <div className="md:max-w-md">
                              <span
                                  className="inline-block mb-5 text-sm text-blue-500 dark:text-green-300 font-bold uppercase tracking-widest">
                              <Translate
                              ...
                              <p className="mb-16 font-bold dark:text-gray-900">
                                  <Translate
                                      ...
                                      Additional extensions for OpenBLD.net service (Chrome, Edge, Brave, Vivaldi, Opera)
                                  </Translate>
                              </p>
