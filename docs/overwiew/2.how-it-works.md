...
- 2019-2023 - OpenBLD.net project started as a personal initiative with name Sys-Adm.in BLD (codename: [abld](https://github.com/m0zgen/abld). BLD means "Blocky Listener Daemon")
- 2023-Current time - OpenBLD.net project was renamed to OpenBLD.net with all updated technology [stack](##technology-stack)
from scratch (codename: _zbld_. BLD means "Block List Domain Daemon" or "Block List DNS") with new features and services named [Gears](/docs/category/gears/) 
