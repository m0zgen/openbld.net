...
- No special requests (such as AXFR, ANY, etc.).
- No brute-forcing of domain or subdomain names.
- Maximum of 100 requests per second per IP address.
- No abuse of the service or any other malicious activity.
- Free for private use. For organizations, a [OpenBLD Plus](4.openbld-plus.md) subscription is required.

:::warning 
- Incoming requests from Virtual servers / Cloud environments will/may be blocked automatically
:::
...
:::note
- Some servers may not ping - this is normal, it's security measure, but the service will work without any problems.
  :::
...
- Are not transferred to third-party services.
- Are not collected for advertising purposes.
- Can be used to improve the quality of the service.
- Can be used for alerts and notifications.
- Are anonymized whenever possible ([details](/blog/openbld-ip-anonymization-feature/)).
...
[Prom++](https://github.com/deckhouse/prompp),
[React](https://react.dev/),
[Tailwind](https://tailwindcss.com/),
[Vue](https://vuejs.org/),
[zBLD](#project-chronology)

And platforms, services, projects:

- [Abuse.ch](https://abuse.ch/), [ZeroSSL](https://zerossl.com/), [ClouDNS](https://www.cloudns.net), [Cloudflare](https://www.cloudflare.com/), [GCore](https://gcore.com/), [3HCLOUD](https://3hcloud.kz/), [Nova Cloud](https://novacloud.kz/), [Unihost.kz](https://unihost.kz/en/), [GoHost.kz](https://gohost.kz/), [AlphaVPS](https://alphavps.com/), [UptimeRobot](https://uptimerobot.com/), [OneHost](https://onehost.kz/), [Digital Ocean](https://www.digitalocean.com/), [PowerDMARC](https://powerdmarc.com/), [GitHub](https://github.com),
[Miek](https://miek.nl/), [db-ip](https://db-ip.com/), [cUrl](https://github.com/curl/curl)

Mainly, OpenBLD.net is based on the following technologies:

- `zBLD` - Zero-Trust BlockList DNS (own internal technology)
- `zLB` - zBLD Load Balancer (own internal technology)
- `benZine` - OpenBLD.net distribution service (own internal technology)
- `Cactusd` - OpenBLD.net distribution service (own internal technology)
...
- 2023-Current time - OpenBLD.net was formed as an independent project, where the entire technological [stack](#technology-stack) was updated from scratch
