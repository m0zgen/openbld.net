...
- 2023-Current time - OpenBLD.net was formed as an independent project, where the entire technological [stack](##technological-stack) was updated from scratch
  and the entire code base was rewritten, taking into account the use of new technologies and packages (codename: _zBLD_, which stands "Zero-Trust Block List DNS") with features and services named [Gears](/docs/category/gears/) 
