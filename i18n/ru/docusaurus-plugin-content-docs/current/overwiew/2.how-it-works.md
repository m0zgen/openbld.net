...
- Бесплатно для частного использования. Для организаций требуется подписка [OpenBLD Plus](/docs/overwiew/openbld-plus/).
...
- Не передаются третьим лицам и сервисам.
- Не собираются в рекламных целях.
- По возможности анонимизируются ([подробнее](/blog/openbld-ip-anonymization-feature/)).
...
- 2023-Настоящее время - OpenBLD.net сформировался, как самостоятельный проект, где с нуля был обновлен весь технологический [стек](#технологический-стек)
и переписана вся кодовая база с учетом использованием новых технологий и пакетов (кодовое имя: _zBLD_, что подразумевает "Zero-Trust BlockList DNS") с возможностями назваными [Шестерни](/docs/category/gears/) 
